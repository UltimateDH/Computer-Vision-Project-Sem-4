...
const createStyles = (colors: ReturnType<typeof useTheme>['colors']) =>
  StyleSheet.create({
    ...
    errorText: { color: '#DC2626', marginBottom: 12, marginLeft: 4, fontSize: 13 },
    loginButton: { backgroundColor: colors.primary, padding: 16, borderRadius: 15, marginTop: 10 },
    loginText: { color: 'white', textAlign: 'center', fontWeight: '600', fontSize: 16 },
    forgot: { textAlign: 'center', color: colors.primary, marginTop: 20 },
